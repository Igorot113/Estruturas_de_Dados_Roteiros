...
// Push adiciona um elemento do topo da pilha
...
// IsEmpty verifica se apilha está vazia
func (s *Stack) IsEmpty() bool {
	return len(s.items) == 0
}
func main() {
	s := Stack{}
	fmt.Println("Adicinando 10")
	s.Push(10)
	fmt.Println("Adicinando 20")
	s.Push(20)
	fmt.Println("Adicinando 30")
	s.Push(30)
